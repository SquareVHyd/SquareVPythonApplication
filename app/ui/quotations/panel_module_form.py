...
class QuickModuleTypeDialog(QDialog):
    """Dialog to quickly add a new module type to the database."""
...
class PanelModuleForm(QDialog):
    def __init__(self, quote_id, panel_id=None, pm_data=None, parent=None, dropdown_lists=None):
        ...
        self.dropdown_lists = dropdown_lists or {} # Storage for shared lists
    ...
    def setup_ui(self):
        ...
        self.add_type_btn.setToolTip("Add new module type")
    ...
    def load_lookups(self):
        ...
        # Load predefined/shared items into combo boxes
    ...
    def _quick_add_type(self):
        """Opens a small dialog to add a module type on the fly."""
    ...
    def get_data(self):
        def update_and_get(combo, list_key):
            ...
            if val and val not in shared_list:
